...
class ModelEvaluation:
    ...
    def get_best_model(self)->Optional[VehicleEstimator]:
        ...
        try:
            ...
            vehicle_estimator=VehicleEstimator(bucket_name=bucket_name,model_path=model_path)
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            if best_model is not None:
                logging.info(f"Computing f1 Score for model...")
    ...
    def initaiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            print("-"*50)
            logging.info("Entereted Model Evaluation")
