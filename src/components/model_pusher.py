...
class ModelPusher:
    ...
    def initiate_model_pusher(self)->ModelPusherArtifact:
        ...
        logging.info("Entered Model Pusher method of Training Pipeline")
        try:
            print("-"*50)
            logging.info("Uploading artifacts to aws s3")
            ...
            logging.info("Uploaded artifacts from folder to s3")
            logging.info(f"Model pusher artifact:[{model_pusher_artifact}]")
            logging.info("Exited initiate_model pusher method of ModelPusher class")
